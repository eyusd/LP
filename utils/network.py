...
class Network():
    ...
    def train(self, epochs):
        ...
        for epoch in range(epochs):
            ...
            for step, (d_in, d_out) in enumerate(self.train_ds):
                #d_in[0] (16,15) d_in[1] (16,6,5) d_in[2] (16,350,7)
                if step % 100 == 0:
    ...
    def runmodel(self, d_in, training=False, use_dropout=True):
        ...
        for i in range(1,d_in[2].shape[1]):
            ...
            (action, phase, weights, atn_t, dm_t), new_states = self.model(inputs = inp, states=new_states, training=training, use_dropout=use_dropout)
