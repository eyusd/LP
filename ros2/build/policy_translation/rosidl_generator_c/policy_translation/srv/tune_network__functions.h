...
#ifndef POLICY_TRANSLATION__SRV__TUNE_NETWORK__FUNCTIONS_H_
#define POLICY_TRANSLATION__SRV__TUNE_NETWORK__FUNCTIONS_H_
...
#include "policy_translation/msg/rosidl_generator_c__visibility_control.h"

#include "policy_translation/srv/tune_network__struct.h"

/// Initialize srv/TuneNetwork message.
/**
...
/// Create srv/TuneNetwork message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * policy_translation__srv__TuneNetwork_Request__init().
...
/// Destroy srv/TuneNetwork message.
/**
 * It calls
 * policy_translation__srv__TuneNetwork_Request__fini()
...
/// Initialize array of srv/TuneNetwork messages.
/**
...
/// Finalize array of srv/TuneNetwork messages.
/**
 * It calls
 * policy_translation__srv__TuneNetwork_Request__fini()
...
/// Create array of srv/TuneNetwork messages.
/**
 * It allocates the memory for the array and calls
 * policy_translation__srv__TuneNetwork_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/TuneNetwork messages.
/**
 * It calls
 * policy_translation__srv__TuneNetwork_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * policy_translation__srv__TuneNetwork_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_policy_translation
...
/**
 * It calls
 * policy_translation__srv__TuneNetwork_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_policy_translation
...
/**
 * It allocates the memory for the array and calls
 * policy_translation__srv__TuneNetwork_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_policy_translation
...
/**
 * It calls
 * policy_translation__srv__TuneNetwork_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // POLICY_TRANSLATION__SRV__TUNE_NETWORK__FUNCTIONS_H_
